        ...
        <div name="pricing"className='w-full text-white my-24'>
            ...
            <div className='max-w-[1240px] mx-auto py-12'>
                <div className='text-center py-8 text-slate-300'>
                    ...
                    <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem quos hic veniam iusto cum perspiciatis placeat deserunt, beatae quod nulla.</p>
                </div>

                <div className='grid md:grid-cols-2'>
                    <div className='bg-white text-slate-900 m-8 p-8 rounded-xl shadow-2xl relative'>
                        ...
                        <div className='text-2xl'>
                            <p className='flex py-4'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 mr-5 text-green-600">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 mr-5 text-green-600">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>Lorem, ipsum dolor.</p>
                            <p className='flex py-4'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 mr-5 text-green-600">
